...
**Certainty: Reasonably ****Inferred  ***The** lie-at-the-root mechanism is consistent with TPM theory and with my direct observation. The specific mechanism by which the Spirit accesses and replaces the lie is not fully understood — this is the frontier of the spiritual calculus and will be discussed in Vol 3.*
